...
public class Blogs {
    ...
    public Blogs(int id, String title, int category_id, String description, String description_detail, String image, String create_by, String create_date, int views) {
        this.id = id;
        this.title = title;
